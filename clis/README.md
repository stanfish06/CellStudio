...
Segmenter input: `.tif/.tiff/.npy` or a directory of tiffs (stacked). Output: label image, 0 = background. Tracker input: TYX/TZYX label stack. Output: `tracks.csv` (+ splits/merges for laptrack), plus masks relabeled by track id.
